...
// class is used for edit string with string class methods
public class StringEditorImpl implements StringEditor {
    ...
    @Override
    public String replaceNextLetter(String input, char findingLetter, char replaceFrom, char replaceTo) throws ValidationException {
        if (input == null) {
            throw new ValidationException("Invalid input parameter");
        }
        StringBuilder stringBuilder = new StringBuilder();
        String[] words = input.split(SPACE);
        char findUpperCase = Character.toUpperCase(findingLetter);
